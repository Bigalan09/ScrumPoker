...
const SVotingCard = class {
  ...
  render() {
    return (h("div", { class: "card" }, h("input", { type: "radio", name: "card", id: this.value }), h("label", { htmlFor: this.value }, this.value)));
  }
};
